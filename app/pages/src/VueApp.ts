...
export function showVueComponent(vueComponent: Component, rootProps?: {[x: string]: unknown} | null) {
  if (!_appInstance) {
    const visibleContent = document.getElementById('visible-content') as HTMLElement;
